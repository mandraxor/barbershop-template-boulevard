    ...
    confDetails.innerHTML = `
      <div class="bg-gray-900 border border-emerald-500/40 rounded-xl p-5 text-left space-y-3">
        ...
        <div class="flex justify-between items-center pt-1">
          ...
          <span class="text-gray-300 text-xs text-right">${window.SHOP_CONFIG?.location ? `${window.SHOP_CONFIG.location.address}, ${window.SHOP_CONFIG.location.city}, ${window.SHOP_CONFIG.location.state} ${window.SHOP_CONFIG.location.zip}` : '906 S 6th St #105, Las Vegas, NV 89101'}</span>
        </div>
      </div>
    `;
